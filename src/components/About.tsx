        ...
        <section className={styles.mainwrapper} id="section2" data-scroll-to="section2">
            <div className={styles.subwrapper}>
                <div className={styles.body_wrapper}>
                    ...
                    Welcome to Crypto Jobs Hub, the go-to platform for finding your next role in the crypto space, managed by <a href="https://x.com/grindingpoet">@GrindingPoet</a> and <a href="https://x.com/pancakesbrah">@Pancakesbrah</a>. We’re here to make job applications easy and accessible—no more waiting in DMs or searching through scattered posts. Just fill out our simple application form, and we’ll follow up with you as soon as possible.
